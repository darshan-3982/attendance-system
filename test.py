...
def get_db_connection():
    return mysql.connector.connect(
        host="localhost",
        user="root",
        password="darshan@3982",  # Replace with your MySQL password
    ...
    try:
        ...
        for db_student_id, db_face_encoding in students_data:
            try:
                ...
                if face_recognition.compare_faces([db_face_encoding], uploaded_face_encoding)[0]:
...
#curl -X POST -F "image=@C:/Users/User/darshan/tushar/WhatsApp Image 2024-11-12 at 13.41.34_429a935f.jpg" http://localhost:5000/mark_attendance
#this is for testing the working for the students on cmd